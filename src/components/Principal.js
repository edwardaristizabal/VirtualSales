    ...
    <div>
        ...
        <div class="container-xl" align="center">
          ...
          <nav class="navbar navbar-light bg-light">
            <a class="navbar-brand" href="/AdmVentas">
              <img src={admventas} height="100" class="d-inline-block align-top" alt="" align="center"/>
              <br />
              <a href="/AdmVentas">
            ...
            <a class="navbar-brand" href="/AdmUsuarios">
              <img src={admusuarios} height="100" class="d-inline-block align-top" alt="" align="center"/>
              <br />
              <a href="/AdmUsuarios">
                <button type="button" class="btn btn-secondary btn-lg">
            ...
            <a class="navbar-brand" href="/GestorVentas">
              <img src={ventas} height="100" class="d-inline-block align-top" alt="" align="center"/>
              <br />
              <a href="/GestorVentas">
                <button type="button" class="btn btn-secondary btn-lg">
                  Gestor de Ventas
            ...
            <a class="navbar-brand" href="/Cambiar_contrasena">
              <img src={contrasena} height="100" class="d-inline-block align-top" alt="" align="center"/>
              <br />
            ...
            <a class="navbar-brand" href="/AdmProductos">
              <img src={vendedores} height="100" class="d-inline-block align-top" alt="" align="center"/>
              <br />
              <a href="/AdmProductos">
                <button type="button" class="btn btn-secondary btn-lg">
      ...
      <div align="center">
        <a class="navbar-brand" href="/HistorialCompraCliente">
          <img src={contacto} width="100" height="100" class="d-inline-block align-top" alt="" align="center"/>
          <br />
          <a href="/HistorialCompraCliente">
            <button type="button" class="btn btn-secondary btn-lg">
              Contactanos
            </button>
          </a>
      ...
      <div class="text-end">
        <a href="/Login">
          <button type="button" class="btn btn-secondary btn-lg" text-alignt="right">
            Cerrar Sesion
          </button>
        </a>
      </div>
