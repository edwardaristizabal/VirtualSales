        ...
        <div align="center">
            ...
            <div class="col-2 container w-90 my-5">
                <form action="#">
                    <div align="Center">
                        <div class="mb-3">
                            <label for="codigo" class="form label">Codigo de Venta:</label>
                            <input type="codigo" class="form-control" name="codigo" placeholder="Autoincrementable" disabled></input>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="cantidad" class="form label">Cantidad Articulos:</label>
